"""
Seed initial data for Smart Attendance System.
Run this script after database migrations to create initial admin and sample data.

Usage: python seed_data.py
"""
from app import app
from models import db, Administrator, Department, AcademicYear, Semester, Campus, Building, Room
...
def seed_admin():
    ...
    existing = Administrator.query.filter_by(username='admin').first()
    if existing:
    ...
    print(f"    Email: admin@attendance.edu")
