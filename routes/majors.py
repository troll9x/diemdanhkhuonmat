"""
Routes Quản Lý Chuyên Ngành (Major Management)
Blueprint: majors_bp — tiền tố URL: /api/majors

Chuyên ngành thuộc khoa (Department). Mỗi sinh viên có thể được gắn với một chuyên ngành.

Endpoints (tất cả yêu cầu JWT; tạo/sửa/xóa chỉ dành cho admin):
  GET    /      — Danh sách chuyên ngành có phân trang, lọc theo tên/khoa/trạng thái
  POST   /      — Tạo chuyên ngành mới
  GET    /<id>  — Chi tiết chuyên ngành
  PUT    /<id>  — Cập nhật chuyên ngành
  DELETE /<id>  — Xóa chuyên ngành (không xóa nếu còn sinh viên liên kết)
"""
