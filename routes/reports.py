"""
Routes Báo Cáo và Xuất Dữ Liệu (Attendance Reports & Exports)
Blueprint: reports_bp — tiền tố URL: /api/reports

Cung cấp báo cáo điểm danh chi tiết và xuất file Excel/CSV.

Endpoints (tất cả yêu cầu JWT):
  GET /attendance        — Báo cáo điểm danh tổng hợp (lọc theo lớp/ngày/sinh viên)
  GET /attendance/export — Xuất báo cáo điểm danh ra file Excel (send_file)
  GET /summary           — Tóm tắt thống kê điểm danh theo lớp
  GET /student/<id>      — Báo cáo điểm danh chi tiết của một sinh viên
"""
