"""
Routes Nhập/Xuất Dữ Liệu Hàng Loạt (Bulk Import & Export)
Blueprint: import_export_bp — tiền tố URL: /api/import-export

Hỗ trợ nhập dữ liệu từ file Excel/CSV và xuất mẫu file.

Endpoints (tất cả yêu cầu JWT admin):
  POST /students/import        — Nhập danh sách sinh viên từ file Excel
  POST /lecturers/import       — Nhập danh sách giảng viên từ file Excel
  GET  /students/template      — Tải xuống file mẫu Excel cho sinh viên
  GET  /lecturers/template     — Tải xuống file mẫu Excel cho giảng viên
  GET  /attendance/export      — Xuất báo cáo điểm danh ra Excel (lọc theo lớp/ngày)
"""
